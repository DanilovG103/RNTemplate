...
export type CharactersFragment = { __typename?: 'Character', id: Maybe<string>, name: Maybe<string>, status: Maybe<string>, image: Maybe<string> };

export type InfoFieldFragment = { __typename?: 'Info', count: Maybe<number> };

export type EpisodeFragment = { __typename?: 'Episode', id: Maybe<string>, name: Maybe<string>, episode: Maybe<string>, air_date: Maybe<string> };

export type LocationFieldFragment = { __typename?: 'Location', id: Maybe<string>, name: Maybe<string>, type: Maybe<string>, dimension: Maybe<string> };
...
export type EpisodesQuery = { __typename?: 'Query', episodes: Maybe<{ __typename?: 'Episodes', info: Maybe<{ __typename?: 'Info', count: Maybe<number> }>, results: Maybe<Array<Maybe<{ __typename?: 'Episode', id: Maybe<string>, name: Maybe<string>, episode: Maybe<string>, air_date: Maybe<string> }>>> }> };
...
export type EpisodeQuery = { __typename?: 'Query', episode: Maybe<{ __typename?: 'Episode', id: Maybe<string>, name: Maybe<string>, episode: Maybe<string>, air_date: Maybe<string>, characters: Array<Maybe<{ __typename?: 'Character', id: Maybe<string>, name: Maybe<string>, status: Maybe<string>, image: Maybe<string> }>> }> };
...
export type LocationsQuery = { __typename?: 'Query', locations: Maybe<{ __typename?: 'Locations', info: Maybe<{ __typename?: 'Info', count: Maybe<number> }>, results: Maybe<Array<Maybe<{ __typename?: 'Location', created: Maybe<string>, id: Maybe<string>, name: Maybe<string>, type: Maybe<string>, dimension: Maybe<string>, residents: Array<Maybe<{ __typename?: 'Character', name: Maybe<string> }>> }>>> }> };
...
export type LocationQuery = { __typename?: 'Query', location: Maybe<{ __typename?: 'Location', id: Maybe<string>, name: Maybe<string>, type: Maybe<string>, dimension: Maybe<string>, residents: Array<Maybe<{ __typename?: 'Character', id: Maybe<string>, name: Maybe<string>, status: Maybe<string>, image: Maybe<string> }>> }> };
